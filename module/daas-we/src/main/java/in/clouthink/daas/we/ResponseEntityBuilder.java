...
public class ResponseEntityBuilder {
	...
	public ResponseEntity<ErrorResponse> buildResponseEntity(Exception ex, String message, HttpStatus status) {
		return buildResponseEntity(ex, message, new HttpHeaders(), status, null);
	}

	public ResponseEntity<ErrorResponse> buildResponseEntity(Exception ex,
															 HttpStatus status,
															 List<FormError> formErrors) {
		return buildResponseEntity(ex, null, new HttpHeaders(), status, formErrors);
	}
	...
	public ResponseEntity<ErrorResponse> buildResponseEntity(Exception ex,
															 ...
															 HttpStatus status,
															 List<FormError> formErrors) {
		return buildResponseEntity(ex, message, new HttpHeaders(), status, formErrors);
	}
